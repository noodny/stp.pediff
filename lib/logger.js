...
var Logger = function(debug) {
    ...
    var events = {
        ...
        'error:specNotFound': function(name) {
            logger.error('spec ' + name + ' does not exist');
        },
        ...
        'server:ready': function(address) {
            var url = address.address;

            url = url.replace('::','localhost');

            logger.info('live server running at http://' + url + ':' + address.port);
        }
    };
